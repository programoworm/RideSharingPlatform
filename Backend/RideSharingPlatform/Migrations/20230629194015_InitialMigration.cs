        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SecurityInChargeName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    SecurityHelpDeskNumber = table.Column<string>(type: "nvarchar(max)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ID = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    RideFrom = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    RideTo = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RTOName = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                    RegistrationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    RegistrationExpiresOn = table.Column<DateTime>(type: "datetime2", nullable: false),
                    InsuranceCompanyName = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    InsuranceNo = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IncidentsIncidentId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RideScheduleID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InspectionStatus = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RTA = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    AlowedVehicles = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    UserId = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                {
                    { 1, 10, "Unitech", "Dunlop" },
                    { 2, 5, "Unitech", "SaltLake" },
                    { 3, 8, "Chinar Park", "Technopolis" },
                    { 4, 6, "Airport", "TCS GP" }
                });
